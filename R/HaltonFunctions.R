...
RSHalton <- function(n = 10, seeds = c(0,0), bases = c(2,3), boxes = 0, J = c(0,0)) {
  ...
  print("Boxes R:")
  print(boxes)
  cboxes <- cppWhere2Start(J = J[1:2], seeds = seeds[1:2], bases = bases[1:2], boxes = saveboxes)
  print("Boxes C:")
  print(cboxes)
...
where2Start <- function(J = c(1,1), seeds = c(0,0), bases = c(2,3), boxes = NULL)
{
  print("where2Start J=")
  print(J)
  print("where2Start seeds=")
  print(seeds)
  print("where2Start bases=")
  print(bases)
  print("where2Start boxes=")
  print(boxes)
  ...
  print("where2Start boxInit=")
  print(boxInit)

  if(is.null(boxes)) return()

  print("B + (boxes - boxInit):")
  print(B + (boxes - boxInit))
  print("boxes - boxInit:")
  print(boxes - boxInit)
