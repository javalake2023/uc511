...
#'
#' @export
BASMasterSample <- function(shapefile, n = 100, boundingbox = NULL, panels = NULL, panel_overlap = NULL,
...
#'
#' @export
point2Frame <- function(pts, bb = NULL, base = base::c(2,3), J = NULL, size = 100)
{
  # Updating to work for sf only. Start here...
