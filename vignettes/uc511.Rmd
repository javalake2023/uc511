...
+ __PopulationSample__ - The sample drawn from the population, it is returned to the user as a __sf__ points object with the __PopulationIndex__, __Order__ and __HaltonIndex__ added as new features to the sample.
...
+ __J__ - The number of grid cells. The default is $c(3, 2)$.
...
The __J__ option controls the number of grid cells. The default value is __(3, 2)__. The __J__ parameter is a list of two values.
